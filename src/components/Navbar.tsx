  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto h-20 px-6 md:px-10 flex items-center justify-between">
        <Link className="flex items-center gap-3.5 group" to="/">
        ...
        {/* 桌面版導覽列 */}
        <nav className={`hidden lg:flex items-center gap-7 text-sm font-medium tracking-wide transition-colors ${scrolled ? 'text-slate-700' : 'text-slate-100'}`}>
          <Link
            to="/"
        ...
        <div className="flex items-center gap-3">
          <Link
            className={`hidden sm:inline-flex items-center gap-2 px-5 py-2.5  text-xs font-semibold tracking-wider transition-all hover:shadow-lg ${
              scrolled
